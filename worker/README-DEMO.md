# SyncOps web demo — Cloudflare Worker proxy
...
- Identity scrub: any mention of Gemini/Google/GPT/OpenAI/LLM/API/worker/B2 → replaced with `SyncOps`. Errors are generic.
...
- Worker: `https://syncops-demo.ssgginfotech.workers.dev` (model `gemini-3.5-flash-lite`; `2.0-flash`/`2.5-flash-lite` are retired for new keys)
